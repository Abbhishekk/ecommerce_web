  ...
  return (
    <div className="flex overflow-hidden gap-5 flex-col h-96 justify-center items-center  mx-auto w-4/5 bg-gradient-to-b from-red-100 to-slate-100" >
        ...
        <div className="flex items-center mx-10" >
            ...
            <button className="text-lg font-semibold border-2 bg-orange-500 md:px-5 px-1 py-1 md:py-3  transition ease-in-out   rounded-3xl text-white hover:text-black hover:bg-transparent hover:border-1 hover:border-orange-500" >Subscribe</button>
        </div>
    </div>
  )
}
